...
<body>
<div align="center"><span class="style20"><img src="images/logo4.png" alt="" width="60" height="50" />HOTEL SAI SURAJ INTERNATIONAL</span></div>
<table width="916" border="0" align="center" background="img/aa.png" bgcolor="#333333">
  <tr>
  ...
  <tr>
    <th height="56" colspan="6" scope="row"><a href="index.html"><img src="img/home3.png" alt="" width="178" height="50"/></a><a href="aboutus.html"><img src="img/aboutus3.png" alt="" width="175" height="50" onclick="aboutus.html" /></a><a href="login2.html"><img src="img/bk3.png" alt="" width="175" height="50" /></a><a href="tourplace.html"><img src="img/tplc3.png" alt="" width="175" height="50" /></a><a href="lmap.html"><img src="img/lmp3.png" alt="" width="180" height="50" /></a></th>
  </tr>
  <tr>
  ...
  <tr>
    ...
    <td width="702"><table width="644" height="60">
      <tr>
        <th width="108" scope="row"><a href="changepass.php"><img src="img/changepassword.png" width="110" height="50" /></a></th>
...
echo "<br><center><strong>Welcome ".$_SESSION['username'].".<br> </strong></center><br><br>";
		...
		if(isset($_POST['submit']))
		{
			...
			echo "<table border='0' style='color:#FFFFFF; background-color:#003300; font-size:18px; font-family:Georgia, 'Times New Roman', Times, serif' align='center'><form action='resconfirm.php' method='post';>
					...
					<tr>
						<td>Room No(s)</td><td><input type='text' name='roomno' value='$rooms_got' onFocus='this.blur()'></td>
					</tr>
					<tr>
